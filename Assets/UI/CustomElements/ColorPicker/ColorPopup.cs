...
namespace Assets.UI.CustomElements.ColorPicker
{
    public class ColorPopup : PopupPanel
    {
        ...
        public string Heading { get; set; } = "Выбор цвета";
        public string ButtonLabel { get; set; } = "Закрыть";
        ...
        private const string popupStylesResource = "Styles/ColorPopupStyleSheet";
