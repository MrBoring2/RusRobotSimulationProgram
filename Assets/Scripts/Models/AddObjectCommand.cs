...
namespace Assets.Scripts.Models
{
    public class AddObjectCommand : ICommand, IDestructiveCommand
    {
        ...
        public AddObjectCommand(GameObject prefab, ObjectType type, Vector3 position, Quaternion rotation, string parentId = null)
        {
        ...
        {
            if (instance == null)
                instance = _sceneObjectManager.Create(prefab, position, rotation, type, parentId: parentId);
            else
